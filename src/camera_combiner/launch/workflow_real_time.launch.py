...
def generate_launch_description():
    ...
    workflow_node = Node(
        ...
        executable='/ros2_object_detection/src/camera_combiner/src/workflow.py',
        name='workflow',
        output='screen',
        remappings=[
    ...
    rviz2_original_node = Node(
        ...
        output='screen',
        arguments=['-d', '/ros2_object_detection/src/camera_combiner/config/workflow_original.rviz']
    )
    ...
    rviz2_fused_node = Node(
        ...
        output='screen',
        arguments=['-d', '/ros2_object_detection/src/camera_combiner/config/workflow_fused.rviz']
    )
    
    # Output launch
    return LaunchDescription([workflow_node, pmd_container, lepton_node, webcam_node, image_proc_lidar_node, image_proc_thermal_node, image_proc_webcam_node, rviz2_original_node, rviz2_fused_node])
